...
<body class="bg-gray-100 bg-fixed bg-[url('/img/background.png')] bg-cover bg-center">
<nav class="bg-gray-800 shadow-md p-2 fixed top-0 left-0 w-full">
...
<div class="container mx-auto p-7 flex justify-center items-center h-screen">
    <div class="bg-green-800 shadow-md rounded-lg p-8 text-center w-full md:w-3/4 lg:w-1/2">
        <h1 class="text-4xl font-bold mb-4 text-yellow-500">Sun-Valley Incident Report System</h1>
        <p class="text-yellow-300 mb-6 text-sm">Report incidents promptly and efficiently.</p>
        <button id="reportButton"
                class="btn bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-3 px-6 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:scale-105">
            Report an Incident
        </button>
        ...
        <div id="reportForm" class="hidden mt-8">
            <form id="incidentForm" action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="incident_type" class="block text-yellow-500 text-sm font-bold mb-2">Incident
                            Type:</label>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="incident_details" name="incident_details" rows="4"
                                  class="shadow appearance-none border rounded w-full py-2 px-3 text-yellow-5000 leading-tight focus:outline-none focus:shadow-outline"></textarea>
                    </div>
                ...
                <div class="flex items-center justify-between mt-4">
                    <button id="submitButton"
                            class="bg-yellow-600 hover:bg-yellow-800 text-yellow-100 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                            type="submit">
                        Submit Report
                    </button>
                </div>
